...
method          encryption method, null by default (AES-256-CFB), the following methods are supported:
                    aes-128-cfb, aes-192-cfb, aes-256-cfb, bf-cfb, cast5-cfb, des-cfb, rc4-md5, chacha20, salsa20
auth            enable One-time-Auth
